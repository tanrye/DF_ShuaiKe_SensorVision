// Generated by gencpp from file vehicle_msgs/Camera_Lane.msg
// DO NOT EDIT!


#ifndef VEHICLE_MSGS_MESSAGE_CAMERA_LANE_H
#define VEHICLE_MSGS_MESSAGE_CAMERA_LANE_H
...
struct Camera_Lane_
{
  ...
  typedef boost::shared_ptr< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> const> ConstPtr;

}; // struct Camera_Lane_

typedef ::vehicle_msgs::Camera_Lane_<std::allocator<void> > Camera_Lane;

typedef boost::shared_ptr< ::vehicle_msgs::Camera_Lane > Camera_LanePtr;
typedef boost::shared_ptr< ::vehicle_msgs::Camera_Lane const> Camera_LaneConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::vehicle_msgs::Camera_Lane_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
{
  ...
  static const char* value(const ::vehicle_msgs::Camera_Lane_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc5897b7b9f9cb0b9ULL;
  static const uint64_t static_value2 = 0x14b0d2214c60af5aULL;
};

template<class ContainerAllocator>
struct DataType< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::vehicle_msgs::Camera_Lane_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vehicle_msgs::Camera_Lane_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // VEHICLE_MSGS_MESSAGE_CAMERA_LANE_H
