// Generated by gencpp from file vehicle_msgs/Camera_Obj.msg
// DO NOT EDIT!


#ifndef VEHICLE_MSGS_MESSAGE_CAMERA_OBJ_H
#define VEHICLE_MSGS_MESSAGE_CAMERA_OBJ_H
...
struct Camera_Obj_
{
  ...
  typedef boost::shared_ptr< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> const> ConstPtr;

}; // struct Camera_Obj_

typedef ::vehicle_msgs::Camera_Obj_<std::allocator<void> > Camera_Obj;

typedef boost::shared_ptr< ::vehicle_msgs::Camera_Obj > Camera_ObjPtr;
typedef boost::shared_ptr< ::vehicle_msgs::Camera_Obj const> Camera_ObjConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::vehicle_msgs::Camera_Obj_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
{
  ...
  static const char* value(const ::vehicle_msgs::Camera_Obj_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa330d04487872660ULL;
  static const uint64_t static_value2 = 0x98e8365de315bedbULL;
};

template<class ContainerAllocator>
struct DataType< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::vehicle_msgs::Camera_Obj_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vehicle_msgs::Camera_Obj_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // VEHICLE_MSGS_MESSAGE_CAMERA_OBJ_H
