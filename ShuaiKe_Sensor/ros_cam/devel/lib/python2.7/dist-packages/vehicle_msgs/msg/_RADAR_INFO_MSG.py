...
"""autogenerated by genpy from vehicle_msgs/RADAR_INFO_MSG.msg. Do not edit."""
import sys
...
class RADAR_INFO_MSG(genpy.Message):
  _md5sum = "4703d32950c4c9bf2e6feee282230d67"
  _type = "vehicle_msgs/RADAR_INFO_MSG"
...
"""
  __slots__ = ['header','messageID','localStamp','globalStamp','radarName','objectNum','objectData']
  _slot_types = ['std_msgs/Header','int32','vehicle_msgs/FrameStamp','vehicle_msgs/FrameStamp','int32','int32','vehicle_msgs/Radar_Object[128]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,messageID,localStamp,globalStamp,radarName,objectNum,objectData
    ...
    """
    if args or kwds:
      super(RADAR_INFO_MSG, self).__init__(*args, **kwds)
      ...
      if self.radarName is None:
        self.radarName = 0
      if self.objectNum is None:
        self.objectNum = 0
      if self.objectData is None:
        self.objectData = [vehicle_msgs.msg.Radar_Object() for _ in range(128)]
    else:
      self.header = std_msgs.msg.Header()
      self.messageID = 0
      self.localStamp = vehicle_msgs.msg.FrameStamp()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i().pack(_x.radarName, _x.objectNum))
      for val1 in self.objectData:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.radarName, _x.objectNum,) = _get_struct_2i().unpack(str[start:end])
      self.objectData = []
      for i in range(0, 128):
        val1 = vehicle_msgs.msg.Radar_Object()
        _v9 = val1.header
        start = end
        end += 4
