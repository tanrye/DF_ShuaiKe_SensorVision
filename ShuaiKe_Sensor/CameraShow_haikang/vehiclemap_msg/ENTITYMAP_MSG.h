// Generated by gencpp from file vehiclemap_msg/ENTITYMAP_MSG.msg
// DO NOT EDIT!


#ifndef VEHICLEMAP_MSG_MESSAGE_ENTITYMAP_MSG_H
#define VEHICLEMAP_MSG_MESSAGE_ENTITYMAP_MSG_H
...
#include "PEDESTRIAN_OBJ.h"
#include "ROAD_OBJ.h"
#include "LANE_OBJ.h"
#include "NEGATIVE_OBSTACLE_OBJ.h"
#include"VEHICLE_OBJ.h"
#include "FARSTATICOBJECT.h"
...
struct ENTITYMAP_MSG_
{
  ...
  ENTITYMAP_MSG_(const ContainerAllocator& _alloc)
    ...
    , index_vehicleinfo(0)  {
  (void)_alloc;
      PdObj.assign( ::vehiclemap_msg::PEDESTRIAN_OBJ_<ContainerAllocator> (_alloc));

      PdLane.assign(0);

      RoadObj.assign( ::vehiclemap_msg::ROAD_OBJ_<ContainerAllocator> (_alloc));

      LaneObj.assign( ::vehiclemap_msg::LANE_OBJ_<ContainerAllocator> (_alloc));

      LaneGenerateType.assign(0);

      NegObj.assign( ::vehiclemap_msg::NEGATIVE_OBSTACLE_OBJ_<ContainerAllocator> (_alloc));

      VehicleObj.assign( ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> (_alloc));

      VehicleLane.assign(0);

      FarStaticObject.assign( ::vehiclemap_msg::FARSTATICOBJECT_<ContainerAllocator> (_alloc));

      RoadMarking.assign( ::vehiclemap_msg::ROAD_MARKING_<ContainerAllocator> (_alloc));

      TrafficSign.assign( ::vehiclemap_msg::TRAFFIC_SIGN_<ContainerAllocator> (_alloc));
  }
  ...
  _PdNum_type PdNum;
   ...
   typedef boost::array< ::vehiclemap_msg::PEDESTRIAN_OBJ_<ContainerAllocator> , 30>  _PdObj_type;
  _PdObj_type PdObj;
  ...
  _RoadNum_type RoadNum;
   ...
   typedef boost::array< ::vehiclemap_msg::ROAD_OBJ_<ContainerAllocator> , 5>  _RoadObj_type;
  ...
  _LaneNum_type LaneNum;
   ...
   typedef boost::array< ::vehiclemap_msg::LANE_OBJ_<ContainerAllocator> , 10>  _LaneObj_type;
  ...
  _NegObNum_type NegObNum;
   ...
   typedef boost::array< ::vehiclemap_msg::NEGATIVE_OBSTACLE_OBJ_<ContainerAllocator> , 20>  _NegObj_type;
  _NegObj_type NegObj;

   typedef int32_t _VehicleNum_type;
  _VehicleNum_type VehicleNum;

   typedef boost::array< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> , 30>  _VehicleObj_type;
  ...
  _FarObjectNum_type FarObjectNum;
   ...
   typedef boost::array< ::vehiclemap_msg::FARSTATICOBJECT_<ContainerAllocator> , 50>  _FarStaticObject_type;
  _FarStaticObject_type FarStaticObject;

   typedef int32_t _RoadMarkingNum_type;
  _RoadMarkingNum_type RoadMarkingNum;

   typedef boost::array< ::vehiclemap_msg::ROAD_MARKING_<ContainerAllocator> , 10>  _RoadMarking_type;
  _RoadMarking_type RoadMarking;

   typedef int32_t _TrafficSignNum_type;
  _TrafficSignNum_type TrafficSignNum;

   typedef boost::array< ::vehiclemap_msg::TRAFFIC_SIGN_<ContainerAllocator> , 5>  _TrafficSign_type;
  _TrafficSign_type TrafficSign;

   typedef int32_t _TrafficLightNum_type;
  _TrafficLightNum_type TrafficLightNum;

   typedef  ::vehiclemap_msg::TRAFFIC_LIGHT_<ContainerAllocator>  _TrafficLight_type;
  ...
  typedef boost::shared_ptr< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> const> ConstPtr;

}; // struct ENTITYMAP_MSG_

typedef ::vehiclemap_msg::ENTITYMAP_MSG_<std::allocator<void> > ENTITYMAP_MSG;

typedef boost::shared_ptr< ::vehiclemap_msg::ENTITYMAP_MSG > ENTITYMAP_MSGPtr;
typedef boost::shared_ptr< ::vehiclemap_msg::ENTITYMAP_MSG const> ENTITYMAP_MSGConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
{
  static const char* value()
  {
    return "1c8a6448ded3193fe80a4e1179860dad";
  }

  static const char* value(const ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1c8a6448ded3193fULL;
  static const uint64_t static_value2 = 0xe80a4e1179860dadULL;
};

template<class ContainerAllocator>
struct DataType< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
{
  static const char* value()
  {
    return "vehiclemap_msg/ENTITYMAP_MSG";
  }
...
template<class ContainerAllocator>
struct Definition< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
{
  static const char* value()
  {
...
\n\
================================================================================\n\
MSG: vehiclemap_msg/PEDESTRIAN_OBJ\n\
int32 PedestrianID\n\
...
\n\
================================================================================\n\
MSG: vehiclemap_msg/NEGATIVE_OBSTACLE_OBJ\n\
int32 NegObID\n\
int32 CenterX    #cm为单位，惯导坐标系\n\
int32 CenterY\n\
...
\n\
================================================================================\n\
MSG: vehiclemap_msg/VEHICLE_OBJ\n\
int32 VehicleID\n\
int32 CenterX         # cm\n\
int32 CenterY\n\
int32 Speed           # cm/s\n\
...
\n\
================================================================================\n\
MSG: vehiclemap_msg/FARSTATICOBJECT\n\
...
\n\
================================================================================\n\
MSG: vehiclemap_msg/ROAD_MARKING\n\
int32 bottomleftx\n\
int32 bottomlefty\n\
int32 bottomrightx\n\
int32 bottomrighty\n\
...
\n\
================================================================================\n\
MSG: vehiclemap_msg/TRAFFIC_SIGN\n\
...
\n\
================================================================================\n\
MSG: vehiclemap_msg/TRAFFIC_LIGHT\n\
uint8 pos_flag		 #是否有效\n\
int32 x			 #坐标\n\
int32 y\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vehiclemap_msg::ENTITYMAP_MSG_<ContainerAllocator>& v)
  {
    s << indent << "MessageID: ";
    ...
    for (size_t i = 0; i < v.PdObj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::PEDESTRIAN_OBJ_<ContainerAllocator> >::stream(s, indent + "    ", v.PdObj[i]);
    }
    ...
    for (size_t i = 0; i < v.RoadObj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::ROAD_OBJ_<ContainerAllocator> >::stream(s, indent + "    ", v.RoadObj[i]);
    }
    ...
    for (size_t i = 0; i < v.LaneObj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::LANE_OBJ_<ContainerAllocator> >::stream(s, indent + "    ", v.LaneObj[i]);
    }
    ...
    for (size_t i = 0; i < v.NegObj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::NEGATIVE_OBSTACLE_OBJ_<ContainerAllocator> >::stream(s, indent + "    ", v.NegObj[i]);
    }
    s << indent << "VehicleNum: ";
    ...
    for (size_t i = 0; i < v.VehicleObj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >::stream(s, indent + "    ", v.VehicleObj[i]);
    }
    ...
    for (size_t i = 0; i < v.FarStaticObject.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::FARSTATICOBJECT_<ContainerAllocator> >::stream(s, indent + "    ", v.FarStaticObject[i]);
    }
    ...
    for (size_t i = 0; i < v.RoadMarking.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::ROAD_MARKING_<ContainerAllocator> >::stream(s, indent + "    ", v.RoadMarking[i]);
    }
    ...
    for (size_t i = 0; i < v.TrafficSign.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::vehiclemap_msg::TRAFFIC_SIGN_<ContainerAllocator> >::stream(s, indent + "    ", v.TrafficSign[i]);
    }
    s << indent << "TrafficLightNum: ";
    Printer<int32_t>::stream(s, indent + "  ", v.TrafficLightNum);
    s << indent << "TrafficLight: ";
    s << std::endl;
    Printer< ::vehiclemap_msg::TRAFFIC_LIGHT_<ContainerAllocator> >::stream(s, indent + "  ", v.TrafficLight);
...
#endif // VEHICLEMAP_MSG_MESSAGE_ENTITYMAP_MSG_H
