// Generated by gencpp from file vehiclemap_msg/VEHICLE_OBJ.msg
// DO NOT EDIT!


#ifndef VEHICLEMAP_MSG_MESSAGE_VEHICLE_OBJ_H
#define VEHICLEMAP_MSG_MESSAGE_VEHICLE_OBJ_H
...
struct VEHICLE_OBJ_
{
  ...
  typedef boost::shared_ptr< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> const> ConstPtr;

}; // struct VEHICLE_OBJ_

typedef ::vehiclemap_msg::VEHICLE_OBJ_<std::allocator<void> > VEHICLE_OBJ;

typedef boost::shared_ptr< ::vehiclemap_msg::VEHICLE_OBJ > VEHICLE_OBJPtr;
typedef boost::shared_ptr< ::vehiclemap_msg::VEHICLE_OBJ const> VEHICLE_OBJConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
{
  ...
  static const char* value(const ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x67a67a234b6a2cacULL;
  static const uint64_t static_value2 = 0x1649aefedf54db2dULL;
};

template<class ContainerAllocator>
struct DataType< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
{
  static const char* value()
  {
    return "vehiclemap_msg/VEHICLE_OBJ";
  }
...
template<class ContainerAllocator>
struct Definition< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vehiclemap_msg::VEHICLE_OBJ_<ContainerAllocator>& v)
  {
    s << indent << "VehicleID: ";
...
#endif // VEHICLEMAP_MSG_MESSAGE_VEHICLE_OBJ_H
