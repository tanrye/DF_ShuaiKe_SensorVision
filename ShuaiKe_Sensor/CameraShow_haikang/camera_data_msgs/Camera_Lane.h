// Generated by gencpp from file camera_data_msgs/Camera_Lane.msg
// DO NOT EDIT!


#ifndef CAMERA_DATA_MSGS_MESSAGE_CAMERA_LANE_H
#define CAMERA_DATA_MSGS_MESSAGE_CAMERA_LANE_H
...
struct Camera_Lane_
{
  ...
  typedef boost::shared_ptr< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> const> ConstPtr;

}; // struct Camera_Lane_

typedef ::camera_data_msgs::Camera_Lane_<std::allocator<void> > Camera_Lane;

typedef boost::shared_ptr< ::camera_data_msgs::Camera_Lane > Camera_LanePtr;
typedef boost::shared_ptr< ::camera_data_msgs::Camera_Lane const> Camera_LaneConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::camera_data_msgs::Camera_Lane_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
{
  ...
  static const char* value(const ::camera_data_msgs::Camera_Lane_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc5897b7b9f9cb0b9ULL;
  static const uint64_t static_value2 = 0x14b0d2214c60af5aULL;
};

template<class ContainerAllocator>
struct DataType< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
{
  static const char* value()
  {
    return "camera_data_msgs/Camera_Lane";
  }
...
template<class ContainerAllocator>
struct Definition< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::camera_data_msgs::Camera_Lane_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // CAMERA_DATA_MSGS_MESSAGE_CAMERA_LANE_H
