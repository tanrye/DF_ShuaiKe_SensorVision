// Generated by gencpp from file camera_data_msgs/Camera_Obj.msg
// DO NOT EDIT!


#ifndef CAMERA_DATA_MSGS_MESSAGE_CAMERA_OBJ_H
#define CAMERA_DATA_MSGS_MESSAGE_CAMERA_OBJ_H
...
struct Camera_Obj_
{
  ...
  typedef boost::shared_ptr< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> const> ConstPtr;

}; // struct Camera_Obj_

typedef ::camera_data_msgs::Camera_Obj_<std::allocator<void> > Camera_Obj;

typedef boost::shared_ptr< ::camera_data_msgs::Camera_Obj > Camera_ObjPtr;
typedef boost::shared_ptr< ::camera_data_msgs::Camera_Obj const> Camera_ObjConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::camera_data_msgs::Camera_Obj_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
{
  ...
  static const char* value(const ::camera_data_msgs::Camera_Obj_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa330d04487872660ULL;
  static const uint64_t static_value2 = 0x98e8365de315bedbULL;
};

template<class ContainerAllocator>
struct DataType< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
{
  static const char* value()
  {
    return "camera_data_msgs/Camera_Obj";
  }
...
template<class ContainerAllocator>
struct Definition< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::camera_data_msgs::Camera_Obj_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // CAMERA_DATA_MSGS_MESSAGE_CAMERA_OBJ_H
