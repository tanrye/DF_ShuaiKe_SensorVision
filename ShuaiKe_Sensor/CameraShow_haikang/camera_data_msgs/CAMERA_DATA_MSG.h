// Generated by gencpp from file camera_data_msgs/CAMERA_DATA_MSG.msg
// DO NOT EDIT!


#ifndef CAMERA_DATA_MSGS_MESSAGE_CAMERA_DATA_MSG_H
#define CAMERA_DATA_MSGS_MESSAGE_CAMERA_DATA_MSG_H
...
//#include <camera_data_msgs/FrameStamp.h>
//#include <camera_data_msgs/Camera.h>
//#include <camera_data_msgs/Camera_Obj.h>
//#include <camera_data_msgs/Camera_Lane.h>
...
struct CAMERA_DATA_MSG_
{
  ...
  CAMERA_DATA_MSG_(const ContainerAllocator& _alloc)
    ...
    , camera_lane(_alloc)  {
  (void)_alloc;
      camera_obj.assign( ::camera_data_msgs::Camera_Obj_<ContainerAllocator> (_alloc));
  }
  ...
  _globalStamp_type globalStamp;
   ...
   typedef  ::camera_data_msgs::Camera_<ContainerAllocator>  _camera_type;
  _camera_type camera;

   typedef boost::array< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> , 10>  _camera_obj_type;
  _camera_obj_type camera_obj;

   typedef  ::camera_data_msgs::Camera_Lane_<ContainerAllocator>  _camera_lane_type;
  _camera_lane_type camera_lane;




  typedef boost::shared_ptr< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> const> ConstPtr;

}; // struct CAMERA_DATA_MSG_

typedef ::camera_data_msgs::CAMERA_DATA_MSG_<std::allocator<void> > CAMERA_DATA_MSG;

typedef boost::shared_ptr< ::camera_data_msgs::CAMERA_DATA_MSG > CAMERA_DATA_MSGPtr;
typedef boost::shared_ptr< ::camera_data_msgs::CAMERA_DATA_MSG const> CAMERA_DATA_MSGConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  ...
  static const char* value(const ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2ca315a7807a0145ULL;
  static const uint64_t static_value2 = 0xe94d098512a2541bULL;
};

template<class ContainerAllocator>
struct DataType< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  static const char* value()
  {
    return "camera_data_msgs/CAMERA_DATA_MSG";
  }
...
template<class ContainerAllocator>
struct Definition< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  static const char* value()
  {
...
\n\
================================================================================\n\
MSG: camera_data_msgs/Camera_Obj\n\
Header  header\n\
int32 	messageID              #为每一个MSG设定唯一的标识码\n\
\n\
FrameStamp localStamp\n\
...
\n\
================================================================================\n\
MSG: camera_data_msgs/Camera_Lane\n\
Header  header\n\
int32 	messageID              #为每一个MSG设定唯一的标识码\n\
\n\
FrameStamp localStamp\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::camera_data_msgs::CAMERA_DATA_MSG_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "camera: ";
    s << std::endl;
    Printer< ::camera_data_msgs::Camera_<ContainerAllocator> >::stream(s, indent + "  ", v.camera);
    ...
    for (size_t i = 0; i < v.camera_obj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::camera_data_msgs::Camera_Obj_<ContainerAllocator> >::stream(s, indent + "    ", v.camera_obj[i]);
    }
    s << indent << "camera_lane: ";
    s << std::endl;
    Printer< ::camera_data_msgs::Camera_Lane_<ContainerAllocator> >::stream(s, indent + "  ", v.camera_lane);
  }
};
...
#endif // CAMERA_DATA_MSGS_MESSAGE_CAMERA_DATA_MSG_H
