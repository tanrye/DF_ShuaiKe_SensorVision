// Generated by gencpp from file msg_radar/Radar_Object.msg
// DO NOT EDIT!


#ifndef MSG_RADAR_MESSAGE_RADAR_OBJECT_H
#define MSG_RADAR_MESSAGE_RADAR_OBJECT_H
...
struct Radar_Object_
{
  ...
  typedef boost::shared_ptr< ::msg_radar::Radar_Object_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::msg_radar::Radar_Object_<ContainerAllocator> const> ConstPtr;

}; // struct Radar_Object_

typedef ::msg_radar::Radar_Object_<std::allocator<void> > Radar_Object;

typedef boost::shared_ptr< ::msg_radar::Radar_Object > Radar_ObjectPtr;
typedef boost::shared_ptr< ::msg_radar::Radar_Object const> Radar_ObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::msg_radar::Radar_Object_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::msg_radar::Radar_Object_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::msg_radar::Radar_Object_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::msg_radar::Radar_Object_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_radar::Radar_Object_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_radar::Radar_Object_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_radar::Radar_Object_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_radar::Radar_Object_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::msg_radar::Radar_Object_<ContainerAllocator> >
{
  static const char* value()
  {
    return "92ce3395d21aa45b95a4e109ba3e1682";
  }

  static const char* value(const ::msg_radar::Radar_Object_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x92ce3395d21aa45bULL;
  static const uint64_t static_value2 = 0x95a4e109ba3e1682ULL;
};

template<class ContainerAllocator>
struct DataType< ::msg_radar::Radar_Object_<ContainerAllocator> >
{
  static const char* value()
  {
    return "msg_radar/Radar_Object";
  }
...
template<class ContainerAllocator>
struct Definition< ::msg_radar::Radar_Object_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::msg_radar::Radar_Object_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::msg_radar::Radar_Object_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::msg_radar::Radar_Object_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MSG_RADAR_MESSAGE_RADAR_OBJECT_H
