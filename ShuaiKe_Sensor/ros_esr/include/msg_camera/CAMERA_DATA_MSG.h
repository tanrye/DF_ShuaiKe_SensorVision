// Generated by gencpp from file msg_camera/CAMERA_DATA_MSG.msg
// DO NOT EDIT!


#ifndef MSG_CAMERA_MESSAGE_CAMERA_DATA_MSG_H
#define MSG_CAMERA_MESSAGE_CAMERA_DATA_MSG_H
...
#include <msg_camera/FrameStamp.h>
#include <msg_camera/Camera.h>
#include <msg_camera/Camera_Obj.h>
#include <msg_camera/Camera_Lane.h>
...
struct CAMERA_DATA_MSG_
{
  ...
  CAMERA_DATA_MSG_(const ContainerAllocator& _alloc)
    ...
    , camera_lane(_alloc)  {
  (void)_alloc;
      camera_obj.assign( ::msg_camera::Camera_Obj_<ContainerAllocator> (_alloc));
  }
  ...
  _globalStamp_type globalStamp;
   ...
   typedef  ::msg_camera::Camera_<ContainerAllocator>  _camera_type;
  _camera_type camera;

   typedef boost::array< ::msg_camera::Camera_Obj_<ContainerAllocator> , 10>  _camera_obj_type;
  _camera_obj_type camera_obj;

   typedef  ::msg_camera::Camera_Lane_<ContainerAllocator>  _camera_lane_type;
  _camera_lane_type camera_lane;




  typedef boost::shared_ptr< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> const> ConstPtr;

}; // struct CAMERA_DATA_MSG_

typedef ::msg_camera::CAMERA_DATA_MSG_<std::allocator<void> > CAMERA_DATA_MSG;

typedef boost::shared_ptr< ::msg_camera::CAMERA_DATA_MSG > CAMERA_DATA_MSGPtr;
typedef boost::shared_ptr< ::msg_camera::CAMERA_DATA_MSG const> CAMERA_DATA_MSGConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  ...
  static const char* value(const ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2ca315a7807a0145ULL;
  static const uint64_t static_value2 = 0xe94d098512a2541bULL;
};

template<class ContainerAllocator>
struct DataType< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  static const char* value()
  {
    return "msg_camera/CAMERA_DATA_MSG";
  }
...
template<class ContainerAllocator>
struct Definition< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::msg_camera::CAMERA_DATA_MSG_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "camera: ";
    s << std::endl;
    Printer< ::msg_camera::Camera_<ContainerAllocator> >::stream(s, indent + "  ", v.camera);
    ...
    for (size_t i = 0; i < v.camera_obj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::msg_camera::Camera_Obj_<ContainerAllocator> >::stream(s, indent + "    ", v.camera_obj[i]);
    }
    s << indent << "camera_lane: ";
    s << std::endl;
    Printer< ::msg_camera::Camera_Lane_<ContainerAllocator> >::stream(s, indent + "  ", v.camera_lane);
  }
};
...
#endif // MSG_CAMERA_MESSAGE_CAMERA_DATA_MSG_H
